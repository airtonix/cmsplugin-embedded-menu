...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MenuPluginSettings'
        db.create_table('cmsplugin_menupluginsettings', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('root', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cms.Page'])),
            ('start_level', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('depth', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('cmsplugin_embeddedmenu', ['MenuPluginSettings'])


    def backwards(self, orm):
        
        # Deleting model 'MenuPluginSettings'
        db.delete_table('cmsplugin_menupluginsettings')
